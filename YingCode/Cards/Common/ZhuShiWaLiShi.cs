...
public class ZhuShiWaLiShi : YingCard
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [
        new DynamicVar("RellyCost", 20m),
        new DynamicVar("DebuffAmount", 20m)
    ];

    public ZhuShiWaLiShi()
        : base(1, CardType.Skill, CardRarity.Basic, TargetType.AllEnemies)
    {
        this.SecondaryCosts().Set(MainFile.RellyId, 20);
    }

    protected override bool ShouldGlowGoldInternal =>
        SecondaryResourceCmd.Get(base.Owner, MainFile.RellyId) >= 20;
    ...
    protected override bool IsPlayable
    {
        get
        {
            ...
            return currentCharge >= 20 && base.IsPlayable;
        }
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        if (handPile.Cards.Any(c => c != this && !c.Keywords.Contains(YingKeywords.JingZhi)))
        {
            ...
            var selectedCards = await CardSelectCmd.FromHand(
                ...
                base.Owner,
                prefs,
                (CardModel c) => c != this && !c.Keywords.Contains(YingKeywords.JingZhi),
                this
            );
            ...
            if (targetCard != null)
            {
                targetCard.AddKeyword(YingKeywords.JingZhi);
            }
        }
